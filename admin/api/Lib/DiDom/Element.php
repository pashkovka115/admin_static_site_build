...
class Element extends Node
{
     ...
     * @param array $attributes The attributes of an element
     *
     * @return \Lib\DiDom\Element
     */
    public static function create($name, $value = null, array $attributes = []): self
    {
        return new \Lib\DiDom\Element($name, $value, $attributes);
    }
     ...
     * @return \Lib\DiDom\Element
     */
    public function setAttribute(string $name, $value): \Lib\DiDom\Element
    {
        if (is_numeric($value)) {
            $value = (string) $value;
        }
     ...
     *
     * @return string|null|\Lib\DiDom\Element
     */
